...
# Function to summarize medical documents
def summarize_medical_document(document):
    ...
    Analyze the document and provide a concise summary that includes key medical events, treatments, and any notable outcomes. This summary should be suitable for legal professionals looking at potential litigation or case studies.
...
df['Llama3few'] = df['REPORT'].progress_apply(summarize_medical_document)
